...
function DashButtons({ reservationsDate }) {
    ...
    <div className="btn-group mt-1 mb-4" role="group">
      ...
      >
        <svg
          ...
          height="18"
          fill="currentColor"
          className="bi bi-calendar-minus mr-2 mb-1"
          viewBox="0 0 16 16"
        >
      ...
      >
        <svg
          ...
          height="18"
          fill="currentColor"
          className="bi bi-calendar-event mr-2 mb-1"
          viewBox="0 0 16 16"
        >
      ...
      >
        <svg
          ...
          height="18"
          fill="currentColor"
          className="bi bi-calendar-plus mr-2 mb-1"
          viewBox="0 0 16 16"
        >
