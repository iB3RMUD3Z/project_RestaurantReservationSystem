...
import DashReservationButtons from "./DashReservationButtons";

function DashListReservations({ reservations, loadReservations }) {
    ...
    return (
      <div className="alert alert-warning py-3" role="alert">
        <svg
          ...
          height="24"
          fill="currentColor"
          className="bi bi-patch-exclamation-fill mb-1 mr-1"
          viewBox="0 0 16 16"
        >
...
export default DashListReservations;
