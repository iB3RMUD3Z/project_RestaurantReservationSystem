...
import SeatReservationButtons from "./SeatReservationButtons";
...
function SeatReservationForm() {
  ...
  return (
    <main>
      <h1 className="mt-lg-4 mt-1 mb-3">Seating Reservation {reservation_id}</h1>
      <ErrorAlert error={error} />
      <form onSubmit={submitHandler} className="mt-3">
        <div className="row">
          <label
            htmlFor="table_assignment"
            className="col-form-label col-auto pr-1 ml-1"
          >
          ...
          <div className="col-auto pl-3">
            <select
              id="table_assignment"
              name="table_id"
              className="form-select mb-2 pr-10"
          ...
          <SeatReservationButtons history={history} />
        </div>
      </form>
    </main>
  );
